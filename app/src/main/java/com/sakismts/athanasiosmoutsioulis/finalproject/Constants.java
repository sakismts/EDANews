...
public final class Constants {
    ...
    static {
        ...
        BAY_AREA_LANDMARKS.put("EDA", new LatLng(51.298231,1.064214));
        BAY_AREA_LANDMARKS.put("HOME", new LatLng(51.279006, 1.075237));
        BAY_AREA_LANDMARKS.put("GREECE", new LatLng(39.664708, 20.849460));
